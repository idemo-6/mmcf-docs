...
1. линия по ПО закрывается без планируемого дальнейшего продолжения;
2. либо изменение неприменимо (`Result=0`);
...
3. либо `Result=-1`, и дальнейшая работа откладывается до будущих условий.
