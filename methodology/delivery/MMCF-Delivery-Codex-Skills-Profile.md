...
Этот документ описывает именно MMCF/Linear delivery subset. В тех же
директориях `codex-skills/` могут сосуществовать и дополнительные
общепроектные навыки, которые не входят в текущий delivery-profile.
