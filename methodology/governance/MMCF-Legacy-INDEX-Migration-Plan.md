...
1. `mmcf-docs/methodology/governance/MMCF-Term-Legacy-Mapping.md`
2. `mmcf-docs/methodology/operational/MMCF-Delta-Registry-and-ChangeFlow-Promotion-Profile.md`
3. `mmcf-docs/methodology/operational/MMCF-Operational-Roles-and-Gateways.md`
4. `mmcf-docs/methodology/context/MMCF-Conflict-and-Applicability-Profile.md`
5. `mmcf-docs/methodology/domain/MMCF-Creativity-and-Variability-Profile.md`
6. `mmcf-docs/methodology/governance/MMCF-Time-and-Cost-FROR-Alignment.md`

### 4.2 Existing documents to update

1. `mmcf-docs/methodology/core/MMCF-Canonical.md`
